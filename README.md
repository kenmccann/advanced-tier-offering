...
As the customer’s consultant you will need to establish whether the customer’s registries are hosted on premise or if they’re using cloud hosted registries, such as Azure ACR, AWS ECR or Google GCR, or both. Additionally the other registries that we support are listed [here](https://docs.aquasec.com/docs/image-registries-and-repositories#section-registry-details-tab)
...
Nzk1OTU4NTEsNDM2OTQzMTI3LDE1NjIzOTQwMDgsLTE2MzMwNT
A5NDYsLTE3MDAxMzAzNjYsODA2ODE3NjE0LC00NDAwODgxNSwt
Nzk1ODcwMjc1XX0=
-->