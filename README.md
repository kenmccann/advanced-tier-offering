...
Your customer  first  might  want  to [manage and   acknowledge](https://docs.aquasec.com/docs/apply-and-manage-security-issue-acknowledgments)   the vulnerabiltiies which they  have indentified to  work  through and  understand.
 
There is  also  a section that  is  related to Reactive Risk Management (https://docs.aquasec.com/docs/reactive-risk-management) section in  our documentation
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MTU0MDkxNCwxNDg5MjkxNTUsMjAyOT
