...
Your customer  first  might  want  to [manage and   acknowledge](https://docs.aquasec.com/docs/apply-and-manage-security-issue-acknowledgments)   the vulnerabiltiies which they  have indentified to  work  through
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI0NzM4NzU0OSwxNDg5MjkxNTUsMjAyOT
