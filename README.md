...
Your customer  first  might  want  to [manage and   acknowledge](https://docs.aquasec.com/docs/apply-and-manage-security-issue-acknowledgments)   the vulnerabiltiies which they  have indentified.   
This  is covered  in our  docs as part  of  the [Reactive Risk Management](https://docs.aquasec.com/docs/reactive-risk-management) section in  our documentation
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NTM1MDc0OTEsMTQ4OTI5MTU1LDIwMj
